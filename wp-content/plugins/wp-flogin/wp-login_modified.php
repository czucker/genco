...
function login_header($title = 'Log In', $message = '', $wp_error = '') {
	global $error, $interim_login, $current_site, $action, $fcl_options;
	...
	?>
	<?php get_header(); ?>
	<?php include_once('themes/'.$fcl_options['general']['theme'].'/template_mid_header.php'); ?>
	<div id="login">
...
function login_footer($input_id = '') {
	global $interim_login, $fcl_options;
...
<?php include_once('themes/'.$fcl_options['general']['theme'].'/template_mid_footer.php'); ?>
<?php get_footer(); ?>
	<?php
}
...
//normally the loginform is the 2nd form!
...
addLoadEvent(function(){ var p=new Array(15,30,15,0,-15,-30,-15,0);p=p.concat(p.concat(p));var i='loginform';g(i).position='relative';shake(i,p,20);});
</script>
<?php
}
...
<p id="wpnav">
<a href="<?php echo esc_url( wp_login_url() ); ?>"><?php _e( 'Log in' ); ?></a> <span id="pwdrecovery"> |
<a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" title="<?php esc_attr_e( 'Password Lost and Found' ) ?>"><?php _e( 'Lost your password?' ); ?></a></span>
</p>
...
<?php include_once('themes/'.$fcl_options['general']['theme'].'/template_login_form.php'); ?>
...
<?php if ( ! isset( $_GET['checkemail'] ) || ! in_array( $_GET['checkemail'], array( 'confirm', 'newpass' ) ) ) :
	...
	?>
	<span id="pwdrecovery"><a href="<?php echo esc_url( wp_lostpassword_url() ); ?>" title="<?php esc_attr_e( 'Password Lost and Found' ); ?>"><?php _e( 'Lost your password?' ); ?></a></span>
<?php endif; ?>
</p>
<?php } ?>
