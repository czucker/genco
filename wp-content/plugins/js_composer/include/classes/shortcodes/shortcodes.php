		...
		protected function singleParamEditForm( $param, $param_value ) {
			...
			if ( $param['type'] == 'textfield' ) {
				...
				foreach ( $values as $label => $v ) {
					...
					$param_line .= ' <label class="vc_checkbox-label"><input id="' . $param['param_name'] . '-' . $v . '" value="' . $v . '" class="wpb_vc_param_value ' . $param['param_name'] . ' ' . $param['type'] . '" type="checkbox" name="' . $param['param_name'] . '"' . $checked . '> ' . __( $label, "js_composer" ) . '</label>';
				}
